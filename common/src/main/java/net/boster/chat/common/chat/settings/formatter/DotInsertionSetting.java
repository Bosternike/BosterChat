...
public class DotInsertionSetting extends ChatFormatterSetting {

    public DotInsertionSetting(@NotNull ConfigurationSection section) {
        super(section);
    }
    ...
    public @Nullable String checkMessage(@NotNull PlayerSender sender, @NotNull String message) {
        ...
        return TextUtils.insertDot(message);
    }
}
